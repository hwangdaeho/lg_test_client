...
let el, elInfo, camera, scene, renderer, gltfModel, sphere, baseModelHeight
...
export default {
  ...
  mounted: function () {
    ...
    Promise.all([
      ...
      //   console.log(child)
      //   if (child.name === 'Scene' && child.type === 'Group') {
      //     const tempBody = new Box3().setFromObject(base.scene)
      //     const tempBodyVector = new Vector3()
      //     const baseJointHeight = tempBody.getSize(tempBodyVector).y
      //     console.log('temp ', baseJointHeight)
      //   }
      // })
